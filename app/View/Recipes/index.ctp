<div class="container">
	<div class="recipes index">
		...
		<tr>
				...
				<th><?php echo $this->Paginator->sort('yield'); ?></th>
		...
		<tr>
			...
			<td><?php echo h($recipe['Recipe']['tag']); ?>&nbsp;</td>
			<td><?php echo h($recipe['Recipe']['photo']); ?>&nbsp;</td>
			<td><?php echo h($recipe['Recipe']['summary']); ?>&nbsp;</td>
			<td><?php echo h($recipe['Recipe']['prep_time']); ?>&nbsp;</td>
			<td><?php echo h($recipe['Recipe']['cook_time']); ?>&nbsp;</td>
			<td><?php echo h($recipe['Recipe']['yield']); ?>&nbsp;</td>
			<td><?php echo h($recipe['Recipe']['author']); ?>&nbsp;</td>
